<template>
  <div>
    ...
    <div class="m-b-lg">
      ...
      <a v-if="ipLocation && !wantChangeLocation" @click="toogleLocation">(change location)</a>
      <a v-if="ipLocation && wantChangeLocation" @click="toogleLocation">(set default location)</a>
