      ...
      <div class="section profile-heading">
        <div class="columns is-mobile is-multiline">
          ...
          <div  @click="activeTab = 'meetups'"
                :class="['stats-tab column is-2-tablet is-4-mobile has-text-centered', {'isActive': activeTab === 'meetups'}]">
          ...
          <div  @click="activeTab = 'threads'"
                :class="['stats-tab column is-2-tablet is-4-mobile has-text-centered', {'isActive': activeTab === 'threads'}]">
          ...
          <div  @click="activeTab = 'posts'"
                :class="['stats-tab column is-2-tablet is-4-mobile has-text-centered', {'isActive': activeTab === 'posts'}]">
