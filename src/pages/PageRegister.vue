    ...
    <div class="hero-body">
      <div class="container has-text-centered">
        <div class="column is-4 is-offset-4">
          ...
          <div class="box">
            <figure class="avatar">
                <img src="https://www.lavanguardia.com/files/image_449_220/uploads/2020/06/29/5fa91c5e49c91.jpeg">
            </figure>
            <form>
              <div class="field">
                <div class="control">
              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.avatar.$error" class="form-error">
                    <span v-if="!$v.form.avatar.url" class="help is-danger">Url not correct</span>
                    <span v-if="!$v.form.avatar.supportedFileType" class="help is-danger">Extension not valid</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.password.$error" class="form-error">
                    ...
                    <span v-if="!$v.form.password.minLength" class="help is-danger">Password min length is 6 letters</span>
                  </div>
                </div>
              </div>
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.passwordConfirmation.$error" class="form-error">
                    <span v-if="!$v.form.passwordConfirmation.required" class="help is-danger">Password Confirmation is required</span>
                     <span v-if="!$v.form.passwordConfirmation.sameAs" class="help is-danger">Password Confirmation must be the same as password</span>
                  </div>
                </div>
              </div>
